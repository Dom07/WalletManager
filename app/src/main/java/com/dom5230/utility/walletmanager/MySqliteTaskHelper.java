...
public class MySqliteTaskHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE TRANS_HISTORY (SERIAL_NUMBER INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT 1, TIMESTAMP TEXT, TRANS_MODE STRING, AMOUNT NUMBER, BALANCE NUMBER) ");
    }
